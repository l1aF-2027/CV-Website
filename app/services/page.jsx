            ...
            return (
              ...
              >
                <div className="w-full flex justify-between items-center">
                  ...
                  <Link href={service.href} className="w-[70px] h-[70px] rounded-full bg-white group-hover:bg-accent transition-all duration-150 flex justify-center items-center group-hover:-rotate-45">
