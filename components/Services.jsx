...
const Services = () => {
    const handleServiceClick = (serviceTitle) => {
        ...
        if (contactElement) {
            ...
            // Set service in contact form after a short delay to ensure contact component is ready
            setTimeout(() => {
                // Dispatch custom event to update contact form
    ...
    return (
        <section className="min-h-[80vh] max-h-80% flex flex-col justify-center py-12 xl:py-0">
                            ...
                            >
                                <div className="w-full flex justify-between items-center">
                                    ...
                                    <button
                                        ...
                                        className="w-[70px] h-[70px] rounded-full bg-white group-hover:bg-accent transition-all duration-150 flex justify-center items-center group-hover:-rotate-45 cursor-pointer"
                                    >
