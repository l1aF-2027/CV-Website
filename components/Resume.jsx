...
import { FaPython, FaHtml5, FaCss3, FaJs, FaMinus, FaPlus } from "react-icons/fa";
    ...
    items: [
        {
            ...
            anotherInfo: {
                gpa: "9.06 or 4.0",
                details: "Major in Artificial Intelligence with focus on Reinforcement Learning and Deep Learning",
                certImage: "/assets/resume/education/uit.png",
            },
        },
        {
            ...
            anotherInfo: {
                tools: ["L: 7.0", "R: 7.5", "W: 6.5", "S: 6.5"],
                details: "Achieved an overall band score of 7.0 in IELTS Academic",
                certImage: "/assets/resume/education/ielts.jpg",
            },
        },
        {
            ...
            duration: "2022 - 2023",
            anotherInfo: {
                details: "Active member participating in AI workshops and projects",
                projects: ["NLP Development", "Computer Vision Project"],
                certImage: "/assets/resume/education/aiclub.png",
            },
        },
        // {
        //     institution: "TEK4.VN",
        ...
        //     anotherInfo: {
        //         grade: "A+",
        //         details: "Completed comprehensive web development course",
        //         certImage: "/placeholder.svg?height=300&width=400",
        //     },
        // },
        // {
        ...
        //         details: "Learning Node.js, Express, and database management",
        //         certImage: "/placeholder.svg?height=300&width=400",
        //     },
        // },
        {
            ...
            anotherInfo: {
                ...
                tools: ["CUDA", "RAPIDS", "XGBoost", "AutoEncoder", "GAN"],
                certImage: "/assets/resume/education/nvidia.png",
            },
        },
    ]
}
                                                                ...
                                                                >
                                                                    <Card className="m-4 bg-[#1a1a1f] border-accent/20">
                                                                        <CardContent className="p-4">
                                                                            {item.anotherInfo.certImage && (
                                                                                <div className="mb-4">
                                                                                    <Image
                                                                                        src={item.anotherInfo.certImage || "/placeholder.svg"}
                                                                                        alt="Certificate"
                                                                                        width={300}
                                                                                        height={200}
                                                                            ...
                                                                            {item.anotherInfo.gpa && (
                                                                                <p className="text-accent font-semibold mb-2">GPA: {item.anotherInfo.gpa}</p>
                                                                            )}
                                                                            {item.anotherInfo.grade && (
                                                                                <p className="text-accent font-semibold mb-2">
                                                                                    Grade: {item.anotherInfo.grade}
                                                                                </p>
                                                                            )}
                                                                            {item.anotherInfo.progress && (
                                                                                <p className="text-accent font-semibold mb-2">
                                                                                    Progress: {item.anotherInfo.progress}
                                                                                </p>
                                                                            )}
                                                                            {item.anotherInfo.details && (
                                                                                <p className="text-white/80 mb-2">{item.anotherInfo.details}</p>
                                                                            )}
                                                                            {item.anotherInfo.projects && (
                                                                                <div className="mb-2">
                                                                                    <p className="text-white/80 font-medium">Projects:</p>
                                                                                    <ul className="list-disc list-inside text-white/60 ml-2">
                                                                                        {item.anotherInfo.projects.map((project, idx) => (
                                                                                            <li key={idx}>{project}</li>
                                                                                        ))}
                                                                                    </ul>
                                                                                </div>
                                                                            )}
                                                                            {item.anotherInfo.tools && (
                                                                                <div>
                                                                                    <p className="text-white/80 font-medium">Detail:</p>
                                                                                    <div className="flex flex-wrap gap-2 mt-1">
                                                                                        {item.anotherInfo.tools.map((tool, idx) => (
                                                                                            <span
                                                                                                key={idx}
